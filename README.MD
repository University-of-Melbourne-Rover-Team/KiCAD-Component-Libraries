...
Creating your KiCad Project with a Component Libraries Folder. In this folder
...
Step:1 Click "Manage Symbol Libraries" while you have your project open
...
you will now see there is a selected footprint, so when you switch to PCB editor and load the changed symbols by pressing 
